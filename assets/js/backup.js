...
function backup_injectUI() {
  try {
    ...
    chooseBtn.setAttribute('aria-label', 'Vybrat složku pro zálohy');
    ...
    // Usnadnění čtečkám: role a popis
    container.setAttribute('role', 'region');
    container.setAttribute('aria-label', 'Panel automatických záloh Palpatius');
